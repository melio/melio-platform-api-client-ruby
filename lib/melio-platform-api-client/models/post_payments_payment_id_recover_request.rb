...
module MelioPlatformApiClient
  class PostPaymentsPaymentIdRecoverRequest
    ...
    attr_accessor :selected_delivery_preference
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `MelioPlatformApiClient::PostPaymentsPaymentIdRecoverRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `MelioPlatformApiClient::PostPaymentsPaymentIdRecoverRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'selected_delivery_preference')
        self.selected_delivery_preference = attributes[:'selected_delivery_preference']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @selected_delivery_preference.nil?
        invalid_properties.push('invalid value for "selected_delivery_preference", selected_delivery_preference cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @selected_delivery_preference.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          selected_delivery_preference == o.selected_delivery_preference
    end
    ...
    def hash
      [funding_source_id, delivery_method_id, note, scheduled_date, selected_delivery_preference].hash
    end
