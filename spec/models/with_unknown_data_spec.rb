...
# Unit tests for MelioPlatformApiClient::WithUnknownData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MelioPlatformApiClient::WithUnknownData do
  let(:instance) { MelioPlatformApiClient::WithUnknownData.new }

  describe 'test an instance of WithUnknownData' do
    it 'should create an instance of WithUnknownData' do
      expect(instance).to be_instance_of(MelioPlatformApiClient::WithUnknownData)
    end
  end
