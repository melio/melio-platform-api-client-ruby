...
# Unit tests for MelioPlatformApiClient::PostAuthResponseData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MelioPlatformApiClient::PostAuthResponseData do
  let(:instance) { MelioPlatformApiClient::PostAuthResponseData.new }

  describe 'test an instance of PostAuthResponseData' do
    it 'should create an instance of PostAuthResponseData' do
      expect(instance).to be_instance_of(MelioPlatformApiClient::PostAuthResponseData)
    end
  end
