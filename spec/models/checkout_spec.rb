...
# Unit tests for MelioPlatformApiClient::Checkout
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MelioPlatformApiClient::Checkout do
  let(:instance) { MelioPlatformApiClient::Checkout.new }

  describe 'test an instance of Checkout' do
    it 'should create an instance of Checkout' do
      expect(instance).to be_instance_of(MelioPlatformApiClient::Checkout)
    end
  end
