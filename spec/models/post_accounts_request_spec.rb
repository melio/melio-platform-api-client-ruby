...
# Unit tests for MelioPlatformApiClient::PostAccountsRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MelioPlatformApiClient::PostAccountsRequest do
  let(:instance) { MelioPlatformApiClient::PostAccountsRequest.new }

  describe 'test an instance of PostAccountsRequest' do
    it 'should create an instance of PostAccountsRequest' do
      expect(instance).to be_instance_of(MelioPlatformApiClient::PostAccountsRequest)
    end
  end
