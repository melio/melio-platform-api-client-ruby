...
# Unit tests for MelioPlatformApiClient::PostPaymentsPaymentIdRecoverResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MelioPlatformApiClient::PostPaymentsPaymentIdRecoverResponse do
  let(:instance) { MelioPlatformApiClient::PostPaymentsPaymentIdRecoverResponse.new }

  describe 'test an instance of PostPaymentsPaymentIdRecoverResponse' do
    it 'should create an instance of PostPaymentsPaymentIdRecoverResponse' do
      expect(instance).to be_instance_of(MelioPlatformApiClient::PostPaymentsPaymentIdRecoverResponse)
    end
  end
