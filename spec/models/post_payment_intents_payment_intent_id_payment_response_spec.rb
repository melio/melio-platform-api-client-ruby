...
# Unit tests for MelioPlatformApiClient::PostPaymentIntentsPaymentIntentIdPaymentResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MelioPlatformApiClient::PostPaymentIntentsPaymentIntentIdPaymentResponse do
  let(:instance) { MelioPlatformApiClient::PostPaymentIntentsPaymentIntentIdPaymentResponse.new }

  describe 'test an instance of PostPaymentIntentsPaymentIntentIdPaymentResponse' do
    it 'should create an instance of PostPaymentIntentsPaymentIntentIdPaymentResponse' do
      expect(instance).to be_instance_of(MelioPlatformApiClient::PostPaymentIntentsPaymentIntentIdPaymentResponse)
    end
  end
