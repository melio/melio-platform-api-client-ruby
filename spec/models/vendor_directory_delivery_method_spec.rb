...
# Unit tests for MelioPlatformApiClient::VendorDirectoryDeliveryMethod
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MelioPlatformApiClient::VendorDirectoryDeliveryMethod do
  let(:instance) { MelioPlatformApiClient::VendorDirectoryDeliveryMethod.new }

  describe 'test an instance of VendorDirectoryDeliveryMethod' do
    it 'should create an instance of VendorDirectoryDeliveryMethod' do
      expect(instance).to be_instance_of(MelioPlatformApiClient::VendorDirectoryDeliveryMethod)
    end
  end
