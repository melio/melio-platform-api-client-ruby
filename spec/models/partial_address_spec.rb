...
# Unit tests for MelioPlatformApiClient::PartialAddress
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MelioPlatformApiClient::PartialAddress do
  let(:instance) { MelioPlatformApiClient::PartialAddress.new }

  describe 'test an instance of PartialAddress' do
    it 'should create an instance of PartialAddress' do
      expect(instance).to be_instance_of(MelioPlatformApiClient::PartialAddress)
    end
  end
