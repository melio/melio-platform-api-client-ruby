...
# Unit tests for MelioPlatformApiClient::Vendor
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MelioPlatformApiClient::Vendor do
  let(:instance) { MelioPlatformApiClient::Vendor.new }

  describe 'test an instance of Vendor' do
    it 'should create an instance of Vendor' do
      expect(instance).to be_instance_of(MelioPlatformApiClient::Vendor)
    end
  end
