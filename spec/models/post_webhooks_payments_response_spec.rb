...
# Unit tests for MelioPlatformApiClient::PostWebhooksPaymentsResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MelioPlatformApiClient::PostWebhooksPaymentsResponse do
  let(:instance) { MelioPlatformApiClient::PostWebhooksPaymentsResponse.new }

  describe 'test an instance of PostWebhooksPaymentsResponse' do
    it 'should create an instance of PostWebhooksPaymentsResponse' do
      expect(instance).to be_instance_of(MelioPlatformApiClient::PostWebhooksPaymentsResponse)
    end
  end
