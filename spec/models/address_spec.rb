...
# Unit tests for MelioPlatformApiClient::Address
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MelioPlatformApiClient::Address do
  let(:instance) { MelioPlatformApiClient::Address.new }

  describe 'test an instance of Address' do
    it 'should create an instance of Address' do
      expect(instance).to be_instance_of(MelioPlatformApiClient::Address)
    end
  end
