...
# Unit tests for MelioPlatformApiClient::PutPaymentIntentsRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MelioPlatformApiClient::PutPaymentIntentsRequest do
  let(:instance) { MelioPlatformApiClient::PutPaymentIntentsRequest.new }

  describe 'test an instance of PutPaymentIntentsRequest' do
    it 'should create an instance of PutPaymentIntentsRequest' do
      expect(instance).to be_instance_of(MelioPlatformApiClient::PutPaymentIntentsRequest)
    end
  end
