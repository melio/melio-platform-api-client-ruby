...
# Unit tests for MelioPlatformApiClient::ChargeAllOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MelioPlatformApiClient::ChargeAllOf do
  let(:instance) { MelioPlatformApiClient::ChargeAllOf.new }

  describe 'test an instance of ChargeAllOf' do
    it 'should create an instance of ChargeAllOf' do
      expect(instance).to be_instance_of(MelioPlatformApiClient::ChargeAllOf)
    end
  end
