...
# Unit tests for MelioPlatformApiClient::GetFilesFileIdResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MelioPlatformApiClient::GetFilesFileIdResponse do
  let(:instance) { MelioPlatformApiClient::GetFilesFileIdResponse.new }

  describe 'test an instance of GetFilesFileIdResponse' do
    it 'should create an instance of GetFilesFileIdResponse' do
      expect(instance).to be_instance_of(MelioPlatformApiClient::GetFilesFileIdResponse)
    end
  end
