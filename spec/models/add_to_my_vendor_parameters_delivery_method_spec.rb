...
# Unit tests for MelioPlatformApiClient::AddToMyVendorParametersDeliveryMethod
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MelioPlatformApiClient::AddToMyVendorParametersDeliveryMethod do
  let(:instance) { MelioPlatformApiClient::AddToMyVendorParametersDeliveryMethod.new }

  describe 'test an instance of AddToMyVendorParametersDeliveryMethod' do
    it 'should create an instance of AddToMyVendorParametersDeliveryMethod' do
      expect(instance).to be_instance_of(MelioPlatformApiClient::AddToMyVendorParametersDeliveryMethod)
    end
  end
  ...
  describe 'test attribute "biller_account"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
