...
# Unit tests for MelioPlatformApiClient::Adjustment
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MelioPlatformApiClient::Adjustment do
  let(:instance) { MelioPlatformApiClient::Adjustment.new }

  describe 'test an instance of Adjustment' do
    it 'should create an instance of Adjustment' do
      expect(instance).to be_instance_of(MelioPlatformApiClient::Adjustment)
    end
  end
