...
# Unit tests for MelioPlatformApiClient::PostWebhooksCheckoutsRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MelioPlatformApiClient::PostWebhooksCheckoutsRequest do
  let(:instance) { MelioPlatformApiClient::PostWebhooksCheckoutsRequest.new }

  describe 'test an instance of PostWebhooksCheckoutsRequest' do
    it 'should create an instance of PostWebhooksCheckoutsRequest' do
      expect(instance).to be_instance_of(MelioPlatformApiClient::PostWebhooksCheckoutsRequest)
    end
  end
