...
# Unit tests for MelioPlatformApiClient::PatchChargesChargeIdRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MelioPlatformApiClient::PatchChargesChargeIdRequest do
  let(:instance) { MelioPlatformApiClient::PatchChargesChargeIdRequest.new }

  describe 'test an instance of PatchChargesChargeIdRequest' do
    it 'should create an instance of PatchChargesChargeIdRequest' do
      expect(instance).to be_instance_of(MelioPlatformApiClient::PatchChargesChargeIdRequest)
    end
  end
