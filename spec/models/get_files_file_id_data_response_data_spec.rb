...
# Unit tests for MelioPlatformApiClient::GetFilesFileIdDataResponseData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MelioPlatformApiClient::GetFilesFileIdDataResponseData do
  let(:instance) { MelioPlatformApiClient::GetFilesFileIdDataResponseData.new }

  describe 'test an instance of GetFilesFileIdDataResponseData' do
    it 'should create an instance of GetFilesFileIdDataResponseData' do
      expect(instance).to be_instance_of(MelioPlatformApiClient::GetFilesFileIdDataResponseData)
    end
  end
