...
# Unit tests for MelioPlatformApiClient::RecoverPaymentResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MelioPlatformApiClient::RecoverPaymentResponse do
  let(:instance) { MelioPlatformApiClient::RecoverPaymentResponse.new }

  describe 'test an instance of RecoverPaymentResponse' do
    it 'should create an instance of RecoverPaymentResponse' do
      expect(instance).to be_instance_of(MelioPlatformApiClient::RecoverPaymentResponse)
    end
  end
