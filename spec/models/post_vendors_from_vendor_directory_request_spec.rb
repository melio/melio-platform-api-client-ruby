...
# Unit tests for MelioPlatformApiClient::PostVendorsFromVendorDirectoryRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MelioPlatformApiClient::PostVendorsFromVendorDirectoryRequest do
  let(:instance) { MelioPlatformApiClient::PostVendorsFromVendorDirectoryRequest.new }

  describe 'test an instance of PostVendorsFromVendorDirectoryRequest' do
    it 'should create an instance of PostVendorsFromVendorDirectoryRequest' do
      expect(instance).to be_instance_of(MelioPlatformApiClient::PostVendorsFromVendorDirectoryRequest)
    end
  end
  describe 'test attribute "vendor_directory_id"' do
    it 'should work' do
