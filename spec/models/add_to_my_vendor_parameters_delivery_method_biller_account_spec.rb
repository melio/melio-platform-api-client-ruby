...
# Unit tests for MelioPlatformApiClient::AddToMyVendorParametersDeliveryMethodBillerAccount
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MelioPlatformApiClient::AddToMyVendorParametersDeliveryMethodBillerAccount do
  let(:instance) { MelioPlatformApiClient::AddToMyVendorParametersDeliveryMethodBillerAccount.new }

  describe 'test an instance of AddToMyVendorParametersDeliveryMethodBillerAccount' do
    it 'should create an instance of AddToMyVendorParametersDeliveryMethodBillerAccount' do
      expect(instance).to be_instance_of(MelioPlatformApiClient::AddToMyVendorParametersDeliveryMethodBillerAccount)
    end
  end
