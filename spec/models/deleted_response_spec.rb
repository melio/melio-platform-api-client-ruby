...
# Unit tests for MelioPlatformApiClient::DeletedResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MelioPlatformApiClient::DeletedResponse do
  let(:instance) { MelioPlatformApiClient::DeletedResponse.new }

  describe 'test an instance of DeletedResponse' do
    it 'should create an instance of DeletedResponse' do
      expect(instance).to be_instance_of(MelioPlatformApiClient::DeletedResponse)
    end
  end
