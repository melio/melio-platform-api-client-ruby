...
# Unit tests for MelioPlatformApiClient::VirtualAccount
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MelioPlatformApiClient::VirtualAccount do
  let(:instance) { MelioPlatformApiClient::VirtualAccount.new }

  describe 'test an instance of VirtualAccount' do
    it 'should create an instance of VirtualAccount' do
      expect(instance).to be_instance_of(MelioPlatformApiClient::VirtualAccount)
    end
  end
