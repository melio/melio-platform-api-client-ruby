...
# Unit tests for MelioPlatformApiClient::PostVendorsResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MelioPlatformApiClient::PostVendorsResponse do
  let(:instance) { MelioPlatformApiClient::PostVendorsResponse.new }

  describe 'test an instance of PostVendorsResponse' do
    it 'should create an instance of PostVendorsResponse' do
      expect(instance).to be_instance_of(MelioPlatformApiClient::PostVendorsResponse)
    end
  end
