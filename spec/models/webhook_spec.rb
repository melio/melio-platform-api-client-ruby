...
# Unit tests for MelioPlatformApiClient::Webhook
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MelioPlatformApiClient::Webhook do
  let(:instance) { MelioPlatformApiClient::Webhook.new }

  describe 'test an instance of Webhook' do
    it 'should create an instance of Webhook' do
      expect(instance).to be_instance_of(MelioPlatformApiClient::Webhook)
    end
  end
