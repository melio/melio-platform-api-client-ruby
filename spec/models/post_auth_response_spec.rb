...
# Unit tests for MelioPlatformApiClient::PostAuthResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MelioPlatformApiClient::PostAuthResponse do
  let(:instance) { MelioPlatformApiClient::PostAuthResponse.new }

  describe 'test an instance of PostAuthResponse' do
    it 'should create an instance of PostAuthResponse' do
      expect(instance).to be_instance_of(MelioPlatformApiClient::PostAuthResponse)
    end
  end
