...
# Unit tests for MelioPlatformApiClient::PatchPaymentIntentsPaymentIntentIdRequestBillInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MelioPlatformApiClient::PatchPaymentIntentsPaymentIntentIdRequestBillInfo do
  let(:instance) { MelioPlatformApiClient::PatchPaymentIntentsPaymentIntentIdRequestBillInfo.new }

  describe 'test an instance of PatchPaymentIntentsPaymentIntentIdRequestBillInfo' do
    it 'should create an instance of PatchPaymentIntentsPaymentIntentIdRequestBillInfo' do
      expect(instance).to be_instance_of(MelioPlatformApiClient::PatchPaymentIntentsPaymentIntentIdRequestBillInfo)
    end
  end
