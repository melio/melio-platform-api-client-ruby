...
# Unit tests for MelioPlatformApiClient::PostMerchantsResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MelioPlatformApiClient::PostMerchantsResponse do
  let(:instance) { MelioPlatformApiClient::PostMerchantsResponse.new }

  describe 'test an instance of PostMerchantsResponse' do
    it 'should create an instance of PostMerchantsResponse' do
      expect(instance).to be_instance_of(MelioPlatformApiClient::PostMerchantsResponse)
    end
  end
