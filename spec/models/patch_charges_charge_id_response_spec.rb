...
# Unit tests for MelioPlatformApiClient::PatchChargesChargeIdResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MelioPlatformApiClient::PatchChargesChargeIdResponse do
  let(:instance) { MelioPlatformApiClient::PatchChargesChargeIdResponse.new }

  describe 'test an instance of PatchChargesChargeIdResponse' do
    it 'should create an instance of PatchChargesChargeIdResponse' do
      expect(instance).to be_instance_of(MelioPlatformApiClient::PatchChargesChargeIdResponse)
    end
  end
