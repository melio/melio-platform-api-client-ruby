...
# Unit tests for MelioPlatformApiClient::CheckoutAllOfBuyer
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MelioPlatformApiClient::CheckoutAllOfBuyer do
  let(:instance) { MelioPlatformApiClient::CheckoutAllOfBuyer.new }

  describe 'test an instance of CheckoutAllOfBuyer' do
    it 'should create an instance of CheckoutAllOfBuyer' do
      expect(instance).to be_instance_of(MelioPlatformApiClient::CheckoutAllOfBuyer)
    end
  end
