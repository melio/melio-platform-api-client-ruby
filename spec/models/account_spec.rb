...
# Unit tests for MelioPlatformApiClient::Account
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MelioPlatformApiClient::Account do
  let(:instance) { MelioPlatformApiClient::Account.new }

  describe 'test an instance of Account' do
    it 'should create an instance of Account' do
      expect(instance).to be_instance_of(MelioPlatformApiClient::Account)
    end
  end
