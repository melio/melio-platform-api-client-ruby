...
# Unit tests for MelioPlatformApiClient::PaperCheck
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MelioPlatformApiClient::PaperCheck do
  let(:instance) { MelioPlatformApiClient::PaperCheck.new }

  describe 'test an instance of PaperCheck' do
    it 'should create an instance of PaperCheck' do
      expect(instance).to be_instance_of(MelioPlatformApiClient::PaperCheck)
    end
  end
  describe 'test attribute "print_name"' do
    it 'should work' do
