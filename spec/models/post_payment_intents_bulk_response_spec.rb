...
# Unit tests for MelioPlatformApiClient::PostPaymentIntentsBulkResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MelioPlatformApiClient::PostPaymentIntentsBulkResponse do
  let(:instance) { MelioPlatformApiClient::PostPaymentIntentsBulkResponse.new }

  describe 'test an instance of PostPaymentIntentsBulkResponse' do
    it 'should create an instance of PostPaymentIntentsBulkResponse' do
      expect(instance).to be_instance_of(MelioPlatformApiClient::PostPaymentIntentsBulkResponse)
    end
  end
