...
# Unit tests for MelioPlatformApiClient::ShortHistory
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MelioPlatformApiClient::ShortHistory do
  let(:instance) { MelioPlatformApiClient::ShortHistory.new }

  describe 'test an instance of ShortHistory' do
    it 'should create an instance of ShortHistory' do
      expect(instance).to be_instance_of(MelioPlatformApiClient::ShortHistory)
    end
  end
