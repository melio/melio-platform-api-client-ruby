...
# Unit tests for MelioPlatformApiClient::BankAccountType
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MelioPlatformApiClient::BankAccountType do
  let(:instance) { MelioPlatformApiClient::BankAccountType.new }

  describe 'test an instance of BankAccountType' do
    it 'should create an instance of BankAccountType' do
      expect(instance).to be_instance_of(MelioPlatformApiClient::BankAccountType)
    end
  end
end
