...
# Unit tests for MelioPlatformApiClient::ConfirmPaymentIntentsResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MelioPlatformApiClient::ConfirmPaymentIntentsResponse do
  let(:instance) { MelioPlatformApiClient::ConfirmPaymentIntentsResponse.new }

  describe 'test an instance of ConfirmPaymentIntentsResponse' do
    it 'should create an instance of ConfirmPaymentIntentsResponse' do
      expect(instance).to be_instance_of(MelioPlatformApiClient::ConfirmPaymentIntentsResponse)
    end
  end
