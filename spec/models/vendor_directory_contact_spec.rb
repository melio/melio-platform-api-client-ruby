...
# Unit tests for MelioPlatformApiClient::VendorDirectoryContact
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MelioPlatformApiClient::VendorDirectoryContact do
  let(:instance) { MelioPlatformApiClient::VendorDirectoryContact.new }

  describe 'test an instance of VendorDirectoryContact' do
    it 'should create an instance of VendorDirectoryContact' do
      expect(instance).to be_instance_of(MelioPlatformApiClient::VendorDirectoryContact)
    end
  end
