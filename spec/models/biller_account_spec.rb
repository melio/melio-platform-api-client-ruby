...
# Unit tests for MelioPlatformApiClient::BillerAccount
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MelioPlatformApiClient::BillerAccount do
  let(:instance) { MelioPlatformApiClient::BillerAccount.new }

  describe 'test an instance of BillerAccount' do
    it 'should create an instance of BillerAccount' do
      expect(instance).to be_instance_of(MelioPlatformApiClient::BillerAccount)
    end
  end
