...
# Unit tests for MelioPlatformApiClient::PostAccountsResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MelioPlatformApiClient::PostAccountsResponse do
  let(:instance) { MelioPlatformApiClient::PostAccountsResponse.new }

  describe 'test an instance of PostAccountsResponse' do
    it 'should create an instance of PostAccountsResponse' do
      expect(instance).to be_instance_of(MelioPlatformApiClient::PostAccountsResponse)
    end
  end
