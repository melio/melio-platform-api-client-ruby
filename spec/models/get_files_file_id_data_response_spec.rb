...
# Unit tests for MelioPlatformApiClient::GetFilesFileIdDataResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MelioPlatformApiClient::GetFilesFileIdDataResponse do
  let(:instance) { MelioPlatformApiClient::GetFilesFileIdDataResponse.new }

  describe 'test an instance of GetFilesFileIdDataResponse' do
    it 'should create an instance of GetFilesFileIdDataResponse' do
      expect(instance).to be_instance_of(MelioPlatformApiClient::GetFilesFileIdDataResponse)
    end
  end
