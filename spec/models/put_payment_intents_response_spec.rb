...
# Unit tests for MelioPlatformApiClient::PutPaymentIntentsResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MelioPlatformApiClient::PutPaymentIntentsResponse do
  let(:instance) { MelioPlatformApiClient::PutPaymentIntentsResponse.new }

  describe 'test an instance of PutPaymentIntentsResponse' do
    it 'should create an instance of PutPaymentIntentsResponse' do
      expect(instance).to be_instance_of(MelioPlatformApiClient::PutPaymentIntentsResponse)
    end
  end
