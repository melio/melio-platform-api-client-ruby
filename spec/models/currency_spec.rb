...
# Unit tests for MelioPlatformApiClient::Currency
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MelioPlatformApiClient::Currency do
  let(:instance) { MelioPlatformApiClient::Currency.new }

  describe 'test an instance of Currency' do
    it 'should create an instance of Currency' do
      expect(instance).to be_instance_of(MelioPlatformApiClient::Currency)
    end
  end
end
