...
# Unit tests for MelioPlatformApiClient::PaymentIntent
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MelioPlatformApiClient::PaymentIntent do
  let(:instance) { MelioPlatformApiClient::PaymentIntent.new }

  describe 'test an instance of PaymentIntent' do
    it 'should create an instance of PaymentIntent' do
      expect(instance).to be_instance_of(MelioPlatformApiClient::PaymentIntent)
    end
  end
