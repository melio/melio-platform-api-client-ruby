...
# Unit tests for MelioPlatformApiClient::VendorDirectoryNotFoundResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MelioPlatformApiClient::VendorDirectoryNotFoundResponse do
  let(:instance) { MelioPlatformApiClient::VendorDirectoryNotFoundResponse.new }

  describe 'test an instance of VendorDirectoryNotFoundResponse' do
    it 'should create an instance of VendorDirectoryNotFoundResponse' do
      expect(instance).to be_instance_of(MelioPlatformApiClient::VendorDirectoryNotFoundResponse)
    end
  end
